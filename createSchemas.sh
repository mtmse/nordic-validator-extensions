...
saxon11-xslt -s:src/main/resources/dtbook/sch/mtm2015-1.sch -o:src/main/resources/dtbook/compiled/mtm2015-1.xsl -xsl:$SCHXSLT_PATH/src/main/resources/content/transpile.xsl
